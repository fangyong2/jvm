package com.labcloud.tdddemo.labTestNg.integration;
...
/**
 * @Author fy
 * @create 2018-12-31 23:52
 * 集成测试
 */
@Transactional
public class labTddIntegrationTestNg extends ControllerTestNgBase {
    ...
    public void beforeTest() {
        ...
        labUser = userService.getUser(restResult, labUser.getId());
    }
